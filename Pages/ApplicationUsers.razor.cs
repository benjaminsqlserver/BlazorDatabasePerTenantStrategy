...
namespace BikeStores.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<BikeStores.Models.ApplicationUser> users;
        protected RadzenDataGrid<BikeStores.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(BikeStores.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(BikeStores.Models.ApplicationUser user)
        {
            try
            {
